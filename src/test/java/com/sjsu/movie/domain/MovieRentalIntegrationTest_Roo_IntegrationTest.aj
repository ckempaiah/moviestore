...
import com.sjsu.movie.domain.MovieRentalIntegrationTest;
...
privileged aspect MovieRentalIntegrationTest_Roo_IntegrationTest {
    
    declare @type: MovieRentalIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: MovieRentalIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: MovieRentalIntegrationTest: @Transactional;
    
    @Autowired
    MovieRentalDataOnDemand MovieRentalIntegrationTest.dod;
    
    @Autowired
    MovieRentalService MovieRentalIntegrationTest.movieRentalService;
    
    @Test
    public void MovieRentalIntegrationTest.testCountAllMovieRentals() {
    ...
    @Test
    public void MovieRentalIntegrationTest.testFindMovieRental() {
    ...
    @Test
    public void MovieRentalIntegrationTest.testFindAllMovieRentals() {
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", dod.getRandomMovieRental());
        long count = movieRentalService.countAllMovieRentals();
    ...
    @Test
    public void MovieRentalIntegrationTest.testFindMovieRentalEntries() {
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", dod.getRandomMovieRental());
        long count = movieRentalService.countAllMovieRentals();
    ...
    @Test
    public void MovieRentalIntegrationTest.testFlush() {
        MovieRental obj = dod.getRandomMovieRental();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to provide an identifier", id);
    ...
    @Test
    public void MovieRentalIntegrationTest.testUpdateMovieRentalUpdate() {
        MovieRental obj = dod.getRandomMovieRental();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to provide an identifier", id);
    ...
    @Test
    public void MovieRentalIntegrationTest.testSaveMovieRental() {
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", dod.getRandomMovieRental());
    ...
    @Test
    public void MovieRentalIntegrationTest.testDeleteMovieRental() {
        MovieRental obj = dod.getRandomMovieRental();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieRental' failed to provide an identifier", id);
