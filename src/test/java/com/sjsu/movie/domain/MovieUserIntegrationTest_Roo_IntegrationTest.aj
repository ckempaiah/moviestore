...
import com.sjsu.movie.domain.MovieUserIntegrationTest;
...
privileged aspect MovieUserIntegrationTest_Roo_IntegrationTest {
    
    declare @type: MovieUserIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: MovieUserIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: MovieUserIntegrationTest: @Transactional;
    
    @Autowired
    MovieUserDataOnDemand MovieUserIntegrationTest.dod;
    
    @Autowired
    MovieUserService MovieUserIntegrationTest.movieUserService;
    
    @Test
    public void MovieUserIntegrationTest.testCountAllMovieUsers() {
    ...
    @Test
    public void MovieUserIntegrationTest.testFindMovieUser() {
    ...
    @Test
    public void MovieUserIntegrationTest.testFindAllMovieUsers() {
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", dod.getRandomMovieUser());
        long count = movieUserService.countAllMovieUsers();
    ...
    @Test
    public void MovieUserIntegrationTest.testFindMovieUserEntries() {
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", dod.getRandomMovieUser());
        long count = movieUserService.countAllMovieUsers();
    ...
    @Test
    public void MovieUserIntegrationTest.testFlush() {
        MovieUser obj = dod.getRandomMovieUser();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to provide an identifier", id);
    ...
    @Test
    public void MovieUserIntegrationTest.testUpdateMovieUserUpdate() {
        MovieUser obj = dod.getRandomMovieUser();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to provide an identifier", id);
    ...
    @Test
    public void MovieUserIntegrationTest.testSaveMovieUser() {
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", dod.getRandomMovieUser());
    ...
    @Test
    public void MovieUserIntegrationTest.testDeleteMovieUser() {
        MovieUser obj = dod.getRandomMovieUser();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MovieUser' failed to provide an identifier", id);
