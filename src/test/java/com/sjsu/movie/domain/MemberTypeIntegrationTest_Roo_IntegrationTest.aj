...
import com.sjsu.movie.domain.MemberTypeIntegrationTest;
...
privileged aspect MemberTypeIntegrationTest_Roo_IntegrationTest {
    
    declare @type: MemberTypeIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: MemberTypeIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: MemberTypeIntegrationTest: @Transactional;
    
    @Autowired
    MemberTypeDataOnDemand MemberTypeIntegrationTest.dod;
    
    @Test
    public void MemberTypeIntegrationTest.testCountMemberTypes() {
    ...
    @Test
    public void MemberTypeIntegrationTest.testFindMemberType() {
    ...
    @Test
    public void MemberTypeIntegrationTest.testFindAllMemberTypes() {
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", dod.getRandomMemberType());
        long count = MemberType.countMemberTypes();
    ...
    @Test
    public void MemberTypeIntegrationTest.testFindMemberTypeEntries() {
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", dod.getRandomMemberType());
        long count = MemberType.countMemberTypes();
    ...
    @Test
    public void MemberTypeIntegrationTest.testFlush() {
        MemberType obj = dod.getRandomMemberType();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to provide an identifier", id);
    ...
    @Test
    public void MemberTypeIntegrationTest.testMergeUpdate() {
        MemberType obj = dod.getRandomMemberType();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to provide an identifier", id);
    ...
    @Test
    public void MemberTypeIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", dod.getRandomMemberType());
    ...
    @Test
    public void MemberTypeIntegrationTest.testRemove() {
        MemberType obj = dod.getRandomMemberType();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MemberType' failed to provide an identifier", id);
