...
import com.sjsu.movie.web.MembershipInfoController;
...
privileged aspect MembershipInfoController_Roo_Controller {
    
    @Autowired
    MovieUserService MembershipInfoController.movieUserService;
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String MembershipInfoController.create(@Valid MembershipInfo membershipInfo, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String MembershipInfoController.createForm(Model uiModel) {
        populateEditForm(uiModel, new MembershipInfo());
        return "membershipinfoes/create";
    }
    
    @RequestMapping(value = "/{id}", produces = "text/html")
    public String MembershipInfoController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String MembershipInfoController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String MembershipInfoController.update(@Valid MembershipInfo membershipInfo, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, membershipInfo);
    ...
    public String MembershipInfoController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, MembershipInfo.findMembershipInfo(id));
        return "membershipinfoes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String MembershipInfoController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void MembershipInfoController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void MembershipInfoController.populateEditForm(Model uiModel, MembershipInfo membershipInfo) {
    ...
    String MembershipInfoController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
